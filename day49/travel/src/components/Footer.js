    ...
    <div className="container px-4 py-16 mx-auto xl:px-20 lg:px-12 sm:px-6">
      <div className="grid grid-cols-2 gap-4 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-4 md:gap-8">
        <div className="flex flex-col flex-shrink-0">
          ...
          <div className="flex items-center mt-12 gap-x-4">
            <button
              ...
              className="flex items-center justify-center flex-shrink-0 w-8 h-8 bg-gray-800 rounded-full opacity-50 cursor-pointer focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-800 hover:bg-gray-700"
            >
              <svg
                width={18}
                height={17}
        ...
        <div className="flex flex-col ml-8 sm:ml-0">
          ...
          <a
            ...
            className="mt-6 text-base leading-4 cursor-pointer focus:outline-none focus:underline hover:text-gray-500 dark:text-white"
          >
            Blog
          </a>
          <a
        ...
        <div className="hidden mt-10 lg:block">
          ...
          <div className="flex items-center justify-between mt-4 border border-gray-800 cursor-pointer ">
            <input
              type="text"
              className="w-full p-4 text-base leading-4 focus:outline-none "
              placeholder="Enter your email"
            />
            <button
              aria-label="send"
              className="mx-4 fill-current focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-800"
            >
              <svg
                width={16}
                height={17}
      ...
      <div className="mt-10 lg:hidden">
        ...
        <div className="flex items-center justify-between mt-4 border ">
          <input
            type="text"
            className="relative z-0 w-full p-4 text-base leading-4focus:outline-none"
            placeholder="Enter your email"
          />
          <button
            aria-label="send"
            className="relative z-40 mx-4 cursor-pointer focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-800"
          >
            <svg
